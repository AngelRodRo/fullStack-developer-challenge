...
export type LoginMutation = {
  ...
  login: {
    __typename?: 'UserSuccessLogin';
    token: string;
    user: { __typename?: 'User'; id?: number | null; email: string };
  };
};
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UserCredentials' },
            },
          },
        },
      ],
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GET_USERS' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<Get_UsersQuery, Get_UsersQueryVariables>;
